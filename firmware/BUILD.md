...
`release/hardware/pcb/v5_7.kicad_pcb`** (v5_7, md5
...
are in `release/hardware/pcb/V5-NOTES.md` and `release/RELEASE.md` row M.
...
`release/hardware/pcb/v5_7.kicad_pcb` (v5_7); its only v5_6 delta is
